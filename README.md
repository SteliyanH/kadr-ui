...
| **`TimelineView`** *(v0.4.1, polished v0.4.2)* | Visual timeline with playhead, tap-to-select, drag-to-reorder, trim handles, live trim resize, tap-to-scrub | `Kadr.Video.clips`, `Kadr.ClipID` |
